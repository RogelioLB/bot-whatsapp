...
export default {
    parameters: z.object({
        ...
        })).describe("The products to add to cart, in this way [{variantId:'gid://shopify/ProductVariant/48061673898259',quantity:1}] as example, if you want to add more than one product, you can add more objects to the array"),
